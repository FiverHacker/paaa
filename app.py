...
async def test_proxy_speed(proxy_id: int):
    ...
    try:
        ...
        try:
            ...
            # Test download speed - use a fast HTTP endpoint
            # Use httpbin.org with larger file size for better accuracy
            speed_test_host = "httpbin.org"
            speed_test_port = 80  # HTTP port
            test_size_mb = 10  # Test with 10MB for better accuracy
            test_size_bytes = test_size_mb * 1024 * 1024  # 10MB in bytes
            ...
            http_request = (
                f"GET /bytes/{test_size_bytes} HTTP/1.1\r\n"  # Request specific size
